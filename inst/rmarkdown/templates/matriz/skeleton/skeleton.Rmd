...
# Função para gerar tabelas com unidades curriculares obrigatórias e optativas de um período
tabela_periodo <- function (matriz, periodo, optativas = FALSE) {
  if (optativas) {
    t <- matriz[
      p >= matriz[["Período"]] & p <= matriz[["Período máximo"]] & !is.na(matriz[["Período"]]) &
        matriz[["Status"]] == "Optativa",
      periodo_cols]
    caption <- 
      paste0("**Quadro ...** - Carga horária presencial teórica (P/T) e prática (P/P) e não ",
             "presencial teórica (NP/T) e prática (NP/P) das unidades curriculares (UC) **optativas** do ",
             nome_periodo[p], " período do Curso.")
  } else {
    t <- matriz[
      matriz[["Período"]] == p & !is.na(matriz[["Período"]]) & matriz[["Status"]] == "Obrigatória",
      periodo_cols]
    ...
    caption <- 
      paste0("**Quadro ...** - Carga horária presencial teórica (P/T) e prática (P/P) e não ",
             "presencial teórica (NP/T) e prática (NP/P) das unidades curriculares (UC) **obrigatórias** do ",
             nome_periodo[p], " período do Curso.")
  }
  t <- rbind(
    t,
...
As unidades curriculares obrigatórias e optativas ofertadas do `r nome_periodo[p]` período do Curso estão dispostas nos quadros abaixos.
